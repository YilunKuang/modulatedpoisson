...
zlabel('Fano Factor')
title('The Growth of Fano Factor for r = 1 / s = 1 / sig_G^2')
...
for i = 2:length(scale_shape_s)
    ...
    set(gca,'FontSize', 18'); box off;
    set(gca,'LineWidth',2); 
    xlabel('mean firing rate'); ylabel('s error for r = 1 / s = 1 / sig_G^2');
...
ylabel('Gamma Parameter')
zlabel('Error')
title('The Error Mountain for r = 1 / s = 1 / sig_G^2')
